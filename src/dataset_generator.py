...
if __name__ == '__main__':
    ...
    for _ in range(1000):
        ...
        setup['annoucements'] = [Expression(Announcement(random.choice([random_expression(setup['variables'], 1), Knowledge(random.choice(setup['agents']), random_expression(setup['variables'], 0))]))) for i in range(setup['n_announcements'])],
